...
public class MapsActivity extends FragmentActivity implements
    ...
    private List<Hotel> latitudeLongitudeList;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Call<List<Hotel>> listCall = hotelAPI.hotelsDetails(Url.token);

        listCall.enqueue(new Callback<List<Hotel>>() {
            @Override
            public void onResponse(Call<List<Hotel>> call, Response<List<Hotel>> response) {
                List<Hotel> latLngs = response.body();
                for (Hotel latlon : latLngs) {
                    double longid = latlon.getLongitude();
                    double latid = latlon.getLatitude();

                    center = CameraUpdateFactory.newLatLng(new LatLng(27.706793, 85.330050));
                    zoom = CameraUpdateFactory.zoomTo(13);
                    mMap.addMarker(new MarkerOptions().title(latlon.getHotelname())
