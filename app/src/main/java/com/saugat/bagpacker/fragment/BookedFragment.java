...
import com.saugat.bagpacker.adapter.currentBookingAdapter;
...
public class BookedFragment extends Fragment {
    ...
    private void loadbooking() {
        ...
        Call<List<Booking>> hotelCall = bookingAPI.currentBooking(Url.id);
        ...
        hotelCall.enqueue(new Callback<List<Booking>>() {
            ...
            public void onResponse(Call<List<Booking>> call, Response<List<Booking>> response) {
                ...
                for (Booking bookings : bookinglist){
                    currentBookingAdapter  ha = new currentBookingAdapter(getContext(), bookinglist);
